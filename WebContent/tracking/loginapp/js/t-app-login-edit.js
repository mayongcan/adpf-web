 ...
 */
function initView(){
	$('#divCreateTime').datetimepicker({locale: 'zh-CN',format: 'YYYY-MM-DD HH:mm:ss'});
	$('#divAttributionPromoId').datetimepicker({locale: 'zh-CN',format: 'YYYY-MM-DD HH:mm:ss'});
	$('#divAttributionTime').datetimepicker({locale: 'zh-CN',format: 'YYYY-MM-DD HH:mm:ss'});
	//判断是新增还是修改

...
function initView(){
	...
	if(g_params.type == "edit"){
		...
		$('#orderId').val(g_params.rows.orderId);
		$('#payType').val(g_params.rows.payType);
		$('#fee').val(g_params.rows.fee);
...
function submitAction(){
	...
	submitData["orderId"] = $("#orderId").val();
	submitData["payType"] = $("#payType").val();
	submitData["fee"] = $("#fee").val();

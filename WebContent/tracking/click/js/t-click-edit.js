...
function initView(){
	...
	if(g_params.type == "edit"){
		...
		$('#callbackUrl').val(g_params.rows.callbackUrl);
		$('#createTime').val(g_params.rows.createTime);
		$('#androidIdMd5').val(g_params.rows.androidIdMd5);
		$('#imeiMd5').val(g_params.rows.imeiMd5);
...
function submitAction(){
	...
	submitData["callbackUrl"] = $("#callbackUrl").val();
	submitData["createTime"] = $("#createTime").val();
	submitData["androidIdMd5"] = $("#androidIdMd5").val();
	submitData["imeiMd5"] = $("#imeiMd5").val();
	//异步处理
	$.ajax({

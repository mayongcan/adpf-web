...
function initTable(){
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/adpf/tracking/startupapp/getList",   		//请求后台的URL（*）
...
function initFuncBtnEvent(){
	...
	$("#tAppStartupEdit").click(function () {
	...
	$("#tAppStartupDel").click(function () {
		...
		appTable.delData($table, $("#tAppStartupDel").data('action-url'), idsList);
    });
}
...
function tAppStartupEdit(id, url){

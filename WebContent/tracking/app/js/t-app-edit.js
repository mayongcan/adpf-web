 ...
 */
function initView(){
    //var appTypeDict = top.app.getDictDataByDictTypeValue('APP_TYPE');
	top.app.addComboBoxOption($("#appType"), g_params.appTypeDict);
    //var staueDict = top.app.getDictDataByDictTypeValue('APP_STATUS');
	top.app.addComboBoxOption($("#staue"), g_params.staueDict);
